...
url='http://em-services-1.int.janelia.org:8080/render-ws/v1/owner/cellmap/project/jrc_velella_b8_1/stack/v3_acquire'

def load_mask(basepath, params, z):
    return None
...
def load_data(basepath, z, s):
    planepath = get_tilepath(z)
    with h5py.File(f'{planepath}', 'r') as fid:
        r = np.array(fid[f'0-0-0/mipmap.{s}'])[0,:,:]
    return r
